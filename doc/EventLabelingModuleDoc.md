...
HTTP 错误的详细描述包含状态码、reason 和最多 4000 字符的服务端响应正文。错误仍写入日志，进度回调按已处理 Event 正常推进，后续 Event 继续请求 VLM。
...
- 2026-07-16：默认 System Prompt 更新为五类动作状态机与具身场景描述规范；本地 LM Studio VLM 接口更新为 `http://192.168.23.106:1234/api/v1/chat`。
